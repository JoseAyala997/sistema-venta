...
import static Presentacion.frmcompras.insertar_deudaCompra;
 ...
 * @author JOSE AYALA
 */
public class FrmFactura_Entrega extends javax.swing.JFrame {
    ...
    void insertarfactura() {
        ...
        datos.setEfectivo(Long.parseLong(txtentrega.getText().replaceAll("\\.", "")));
        datos.setVuelto(Long.parseLong(txtsaldo.getText().replaceAll("\\.", "")));
...
//    }
    ...
    void factura() {
        if (txtentrega.getText().length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "El campo de entrega no puede estar vacio");
            txtentrega.setText("0");
            return;
        }
        int monto = Integer.parseInt(txtMonto.getText().replaceAll("\\.", ""));
        int efe = Integer.parseInt(txtentrega.getText().replaceAll("\\.", ""));

//               if (txtEfectivo.getText().length()==0) {
        if (efe > monto) {

            JOptionPane.showMessageDialog(rootPane, "La entrega no puede ser mayor al monto");
            txtentrega.requestFocus();
        } else {
            frmventas.insertar_deuda();
            insertarVenta();
            insertarfactura();
            frmventas.NroFctura();
...
//            imprimir();
    ...
    private void initComponents() {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(25, 25, 25)
                        .addComponent(txtsaldo, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(4, 4, 4)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(24, 24, 24)
                                .addComponent(txtentrega, javax.swing.GroupLayout.PREFERRED_SIZE, 287, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(txttipo, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(61, 61, 61)
                        .addComponent(txtnropago, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE))))
            .addGroup(layout.createSequentialGroup()
                .addGap(220, 220, 220)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtnropago, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtentrega, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(40, 40, 40)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(3, 3, 3)
    ...
    private void txtentregaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtentregaKeyReleased
        ...
        txtentrega.setText(txtentrega.getText().replaceAll("\\.", ""));
        int c = Integer.parseInt(txtentrega.getText());
        txtentrega.setText(format.format(c) + "");
        int monto = Integer.parseInt(txtMonto.getText().replaceAll("\\.", ""));
        int calculo = monto - c;
        txtsaldo.setText("" + format.format(calculo));
    ...
    public static void imprimir() {
        ...
        try {
            ...
            Map p = new HashMap();
            p.put("importe", txtentrega.getText());
            p.put("VUELTO", txtsaldo.getText());
...
//        btnAceptar.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmFactura_Entrega.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmFactura_Entrega().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTextField txtnropago;
